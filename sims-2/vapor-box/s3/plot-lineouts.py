...
fh = tables.openFile("s3-two-box-chain_q_10.h5")
...
axis('tight')
savefig('s3-two-box-chain-numDensity.png')
...
ylabel('Temperature')
axis('tight')
savefig('s3-two-box-chain-temperature.png')
...
ylabel('Mach Number')
axis('tight')
savefig('s3-two-box-chain-mach.png')
...
ylabel('Number Density')
axis('tight')
savefig('s3-two-box-chain-ln-numDensity.png')
