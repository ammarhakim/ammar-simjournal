...
fh = tables.openFile("s7-four-box-chain_q_10.h5")
...
axis('tight')
savefig('s7-four-box-chain-numDensity.png')
...
ylabel('Temperature')
axis('tight')
savefig('s7-four-box-chain-temperature.png')
...
ylabel('Mach Number')
axis('tight')
savefig('s7-four-box-chain-mach.png')
...
ylabel('Pressure')
axis('tight')
savefig('s7-four-box-chain-press.png')
...
ylabel('Number Density')
axis('tight')
savefig('s7-four-box-chain-ln-numDensity.png')
...
ylabel('Pressure')
axis('tight')
savefig('s7-four-box-chain-ln-press.png')
...
ylabel('X-velocity')
axis('tight')
savefig('s7-four-box-chain-ln-xvel.png')
...
ylabel('X-velocity')
axis('tight')
savefig('s7-four-box-chain-xvel.png')
...
axis('tight')
savefig('s7-four-box-chain-enthalphy.png')
...
ylabel('Y-velocity')
axis('tight')
savefig('s7-four-box-chain-yvel.png')
