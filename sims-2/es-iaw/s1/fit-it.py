...
dat = loadtxt("s1-es-iaw_phiInCell.dat")
T = dat[:,0]
E = dat[:,1]
dt = T[1]-T[0]
wH = 124.9 # computed from Maxima

# FFT filter it, removing high-frequency
fE = real(postgkyl.tools.butterFiltering(E/E[0], dt, 0.5*0.9*wH/(2*pi)))
plot(T, fE)
grid()
...
t1, v1 = findMax(4.5, 5.5)
t2, v2 = findMax(9.0, 10.0)
t3, v3 = findMax(13.5, 14.9)
