...
-- problem parameters
Te_Ti = 400.0 -- ratio of electron to ion temperaute
...
-- domain sizea and simulation time
LX = 100*lambdaD
tEnd = 50.0/wpe
nFrames = 50
...
VL_ION, VU_ION = -10.0*vtIon-ionDrift, 10.0*vtIon+ionDrift  -- -6.0*vtIon, 6.0*vtIon
