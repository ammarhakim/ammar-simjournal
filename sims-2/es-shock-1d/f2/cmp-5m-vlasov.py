...
d = gkedata.GkeData("../m2/m2-es-shock_numDensityElc_100.h5")
dg = gkedgbasis.GkeDgLobatto1DPolyOrder2Basis(d)
Xc, numElc = dg.project(0)

d = gkedata.GkeData("f2-5m-es-shock_q_100.h5")
...
savefig('f2-m2-fluid-kinetic-cmp-elc-numDens.png')

# ion number density
d = gkedata.GkeData("../m2/m2-es-shock_numDensityIon_100.h5")
dg = gkedgbasis.GkeDgLobatto1DPolyOrder2Basis(d)
...
savefig('f2-m2-fluid-kinetic-cmp-ion-numDens.png')

######

# electron momentum density
d = gkedata.GkeData("../m2/m2-es-shock_momentumElc_100.h5")
dg = gkedgbasis.GkeDgLobatto1DPolyOrder2Basis(d)
...
savefig('f2-m2-fluid-kinetic-cmp-elc-momDens.png')

# ion momentum density
d = gkedata.GkeData("../m2/m2-es-shock_momentumIon_100.h5")
dg = gkedgbasis.GkeDgLobatto1DPolyOrder2Basis(d)
...
savefig('f2-m2-fluid-kinetic-cmp-ion-momDens.png')

######

# electron energy density
d = gkedata.GkeData("../m2/m2-es-shock_ptclEnergyElc_100.h5")
dg = gkedgbasis.GkeDgLobatto1DPolyOrder2Basis(d)
...
savefig('f2-m2-fluid-kinetic-cmp-elc-enrDens.png')

# ion momentum density
d = gkedata.GkeData("../m2/m2-es-shock_ptclEnergyIon_100.h5")
dg = gkedgbasis.GkeDgLobatto1DPolyOrder2Basis(d)
...
savefig('f2-m2-fluid-kinetic-cmp-ion-enrDens.png')
