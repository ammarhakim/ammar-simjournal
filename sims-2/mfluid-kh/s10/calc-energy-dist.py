...
for i in range(0, 101):
    ...
    fh = tables.openFile("s10-10m-karim-kh_q_%d.h5" % i)
...
# write data to file
writeDat("s10-10m-karim-kh_totKe_e.txt", totKe_e)
writeDat("s10-10m-karim-kh_totIe_e.txt", totIe_e)
writeDat("s10-10m-karim-kh_totKe_i.txt", totKe_i)
writeDat("s10-10m-karim-kh_totIe_i.txt", totIe_i)
writeDat("s10-10m-karim-kh_totEm.txt", totEm)
writeDat("s10-10m-karim-kh_totBxBy.txt", totBxBy)
