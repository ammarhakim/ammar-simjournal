...
# read data
d = gkedata.GkeData("s1-dg-euler-pos_q_1.h5")
...
ex_density = pylab.loadtxt("s9-euler-shock-exact-density.txt")
ex_velocity = pylab.loadtxt("s9-euler-shock-exact-velocity.txt")
ex_pressure = pylab.loadtxt("s9-euler-shock-exact-pressure.txt")
ex_ie = pylab.loadtxt("s9-euler-shock-exact-internal-energy.txt")
...
pylab.savefig("s1-dg-euler-pos_exact_cmp.png")#, bbox_inches='tight')
