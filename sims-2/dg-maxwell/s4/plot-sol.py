...
fh = tables.openFile("s4-dg-maxwell_q_1.h5")
...
# get final solution
q = getRaw(fh.root.StructGridField, 2, 8, 8)
Xn, Yn, qn_1 = projectOnFinerGrid_f(Xc, Yc, q)

# get intial solution
fh = tables.openFile("s4-dg-maxwell_q_0.h5")
q = getRaw(fh.root.StructGridField, 2, 8, 8)
...
pylab.axis('tight')
pylab.savefig('s4-dg-maxwell-Ez.png')
