...
fh = tables.openFile("s12-dg-maxwell_q_1.h5")
...
# get intial solution
fh = tables.openFile("s12-dg-maxwell_q_2.h5")
q0 = getRaw(fh.root.StructGridField, 2, 8, 8)
Xn, Yn, qn_2 = projectOnFinerGrid_f(Xc, Yc, q0)

pylab.subplot(1,2,2)
im = pylab.pcolormesh(Xn, Yn, pylab.transpose(qn_2))
pylab.title('t=3.0')
pylab.axis('image')
#colorbar_adj(im)
#pylab.colorbar(orientation='horizontal')

pylab.savefig('s12-ez.png', bbox_inches='tight')
