...
refTe = tr_125[0,1]
pylab.plot(tr_125[:,0], tr_125[:,1]-tr_125[0,1]+refTe, label='CFL 0.2')
pylab.plot(tr_129[:,0], tr_129[:,1]-tr_129[0,1]+refTe, label='CFL 0.1')
pylab.plot(tr_130[:,0], tr_130[:,1]-tr_130[0,1]+refTe, label='CFL 0.05')
