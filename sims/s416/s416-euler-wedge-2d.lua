...
decomp = DecompRegionCalc2D.CartProd { cuts = {2, 1} }
...
-- debugging
nProcs = Lucee.getNumProcs()
lo0 = grid:localLowerIndex(0)
lo1 = grid:localLowerIndex(1)
up0 = grid:localUpperIndex(0)
up1 = grid:localUpperIndex(1)
log (string.format("Rank %d lower (%d,%d) upper (%d,%d)", Lucee.getRank(), lo0, lo1, up0, up1))
----
