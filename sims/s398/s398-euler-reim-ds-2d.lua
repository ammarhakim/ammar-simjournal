...
-- initial conditions
function init(x,y,z)
   -- Case 15 from Liska and Wendroff 2003 (see Table 4.3)
   -- these tables store pressure, rho, u and v
   local upLeft = {0.4, 0.5197, -0.6259, -0.3}
   local upRight = {1.0, 1.0, 0.1, -0.3}
   local loLeft = {0.4, 0.8, 0.1, -0.3}
   local loRight = {0.4, 0.5313, 0.1, 0.4276}
