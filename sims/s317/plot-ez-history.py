...
# load data
dat = loadtxt('s317-5m-gem_xpointEz.txt')
T = dat[:,0]
Ez = dat[:,1]

dat = loadtxt('s317-5m-gem_xpointUze.txt')
zMomE = dat[:,1]

dat = loadtxt('s317-5m-gem_xpointUzi.txt')
zMomI = dat[:,1]

dat = loadtxt('s317-5m-gem_xpointNe.txt')
rhoE = dat[:,1]
...
xlabel('Time')
ylabel('Uze')
savefig('s317-uze-measured-vs-integrated.png')
...
xlabel('Time')
ylabel('Uzi')
savefig('s317-uzi-measured-vs-integrated.png')
...
xlabel('Time')
ylabel('Uzi')
savefig('s317-jz-measured-vs-integrated.png')
...
xlabel('Time')
ylabel('Uze-Uzi')
savefig('s317-uDiff-measured-vs-integrated.png')
