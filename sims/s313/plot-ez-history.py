...
# load data
dat = loadtxt('s313-5m-gem_xpointEz.txt')
T = dat[:,0]
Ez = dat[:,1]

dat = loadtxt('s313-5m-gem_xpointUze.txt')
zMomE = dat[:,1]

dat = loadtxt('s313-5m-gem_xpointUzi.txt')
zMomI = dat[:,1]

dat = loadtxt('s313-5m-gem_xpointNe.txt')
rhoE = dat[:,1]
...
xlabel('Time')
ylabel('Uze')
savefig('s313-uze-measured-vs-integrated.png')
...
xlabel('Time')
ylabel('Uzi')
savefig('s313-uzi-measured-vs-integrated.png')
...
xlabel('Time')
ylabel('Uzi')
savefig('s313-jz-measured-vs-integrated.png')
...
xlabel('Time')
ylabel('Uze-Uzi')
savefig('s313-uDiff-measured-vs-integrated.png')
