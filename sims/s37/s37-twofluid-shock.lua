...
ionEulerSlvr = Updater.WavePropagation1D {
   onGrid = grid,
...
function solveTwoFluidSystem(tCurr, t)
   ...
   ionStatus, ionDtSuggested = ionEulerSlvr:advance(t)
   -- advance fields
...
--elcFluid:write("elc_1.txt")
--ionFluid:write("ion_1.txt")
--emField:write("em_1.txt")
q:write("q_1.h5")