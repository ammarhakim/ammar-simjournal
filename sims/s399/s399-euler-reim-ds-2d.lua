...
-- initial conditions
function init(x,y,z)
   -- Case 17 from Liska and Wendroff 2003 (see Table 4.3) these
   -- tables store pressure, rho, u and v
   local upLeft = {1.0, 2.0, 0.0, -0.3}
   local upRight = {1.0, 1.0, 0.0, -0.4}
   local loLeft = {0.4, 1.0625, 0.0, 0.2145}
   local loRight = {0.4, 0.5197, 0.0, -1.1259}
