...
# load data
dat = loadtxt('s326-iso-gem_xpointEz.txt')
T = dat[:,0]
Ez = dat[:,1]

dat = loadtxt('s326-iso-gem_xpointUze.txt')
zMomE = dat[:,1]

dat = loadtxt('s326-iso-gem_xpointUzi.txt')
zMomI = dat[:,1]

dat = loadtxt('s326-iso-gem_xpointNe.txt')
rhoE = dat[:,1]
