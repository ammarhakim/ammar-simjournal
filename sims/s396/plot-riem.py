...
fh = tables.openFile("s396-euler-reim-ds-2d_q_5.h5")
...
cList = linspace(0.16, 1.71, nlevels)
contour(XX, YY, transpose(rho), 50, colors='k')

savefig('s396-pr-dens-flow.png', dpi=300, bbox_inches='tight')
