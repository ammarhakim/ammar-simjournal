...
refTe = tr_131[0,1]
pylab.plot(tr_131[:,0], (tr_131[:,1]-tr_131[0,1]+refTe)/refTe, label='CFL 0.2')
pylab.plot(tr_132[:,0], (tr_132[:,1]-tr_132[0,1]+refTe)/refTe, label='CFL 0.1')
pylab.plot(tr_133[:,0], (tr_133[:,1]-tr_133[0,1]+refTe)/refTe, label='CFL 0.05')
