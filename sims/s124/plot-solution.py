...
fh = tables.openFile("s124-pb-advection-sf_chi_1.h5")
...
# for comparison
# get intial solution
fh = tables.openFile("s124-pb-advection-sf_chi_0.h5")
...
pylab.axis('image')
pylab.title('T=3.0')
pylab.savefig('s124-solution.png')
...
pylab.savefig('s124-projected-solution.png')
...
pylab.savefig('s124-total-enstrophy.png')
