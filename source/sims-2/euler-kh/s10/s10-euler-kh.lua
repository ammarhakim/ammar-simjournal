...
YL = -0.5
YU = 0.5
rhoL = 0.05 -- gradient length scale for density
velL = 0.05 -- gradient length scale for velocity
...
function init(x,y,z)
   ...
   vx = vx + 0.01*math.sin(Lucee.Pi*x/Lx)
   local vy = 0.01*math.sin(Lucee.Pi*x/Lx)
   local pr = 2.5
