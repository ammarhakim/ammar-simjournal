...
-- initial conditions
function init(x,y,z)
   -- Case 12 from Liska and Wendroff 2003 (see Table 4.3)
   -- these tables store pressure, rho, u and v
   local upLeft = {1.0, 1.0, 0.7276, 0.0}
   local upRight = {0.4, 0.5313, 0.0, 0.0}
   local loLeft = {1.0, 0.8, 0.0, 0.0}
   local loRight = {1.0, 1.0, 0.0, 0.7276}
