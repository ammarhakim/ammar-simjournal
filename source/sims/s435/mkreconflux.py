...
for i in range(0,51):
    ...
    fh = tables.openFile("../s435/s435-is-coal_q_%d.h5" % i)
...
savefig("s435-reconFlux.png")
array(tmPoints).tofile("s435-recon-tmPoints", " ")
array(reconFlux).tofile("s435-recon-reconFlux", " ")
show()
