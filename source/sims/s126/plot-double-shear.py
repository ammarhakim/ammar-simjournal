...
# load first frame to determine mesh shape
fh = tables.openFile("s126-double-shear_chi_%d.h5" % 0)
nx, ny = fh.root.StructGrid._v_attrs.vsNumCells
...
for i in range(nFrame):
    print "Working on ", i
    fh = tables.openFile("s126-double-shear_chi_%d.h5" % i)
    ...
    pylab.savefig('s126-double-shear_%05d.png' % i)
    pylab.close()
