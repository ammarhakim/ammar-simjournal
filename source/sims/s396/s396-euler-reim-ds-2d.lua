...
-- initial conditions
function init(x,y,z)
   -- Case 6 from Liska and Wendroff 2003 (see Table 4.3)
   -- these tables store pressure, rho, u and v
   local upLeft = {1.0, 2.0, 0.75, 0.5}
   local upRight = {1.0, 1.0, 0.75, -0.5}
   local loLeft = {1.0, 1.0, -0.75, 0.5}
   local loRight = {1.0, 3.0, -0.75, -0.5}
