...
fh = tables.openFile("s420-euler-cyl-2d_q_10.h5")
...
fh = tables.openFile("s420-euler-cyl-2d_inOut.h5")
...
contour(X, Y, transpose(rhoMa), 20, colors='k', linewidth=0.1)
...
savefig('s420-density-pressure.png', dpi=300)
