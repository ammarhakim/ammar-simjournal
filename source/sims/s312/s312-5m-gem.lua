...
function init(x,y,z)
   ...
   local sech2 = (1/math.cosh(y/lambda))^2
   local eC = math.abs(elcCharge)
   -- equilibrium electric field
   local Ey = -2*n0*Ti*sech2*math.tanh(y/lambda)/(n0*sech2+0.2*n0)/(eC*lambda)
   ...
   return rhoe, 0.0, 0.0, ezmom, ere, rhoi, 0.0, 0.0, 0.0, eri, 0.0, Ey, 0.0, Bx, By, 0.0, 0.0, 0.0
end
