...
initProfile = "one-cell" -- one of "gaussian", "step", "cylinder", "expTent", "square-hat"
...
function oneCell(t, xn)
   if xn[1] >= 2.0 and xn[1] <=3.0 then
      return 1.0
   end
   return 1.0e-5
end
...
elseif initProfile == "square-hat" then
   initFunc = squareHat
elseif initProfile == "one-cell" then
   initFunc = oneCell
else
   initFunc = nil
end
