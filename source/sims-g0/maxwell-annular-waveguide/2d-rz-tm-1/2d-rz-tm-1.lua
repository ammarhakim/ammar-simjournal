...
app = Moments.App {
   ...
   lower = {r0, -0.1, 0.0}, -- lower left corner
   upper = {r1, 0.1, Lz}, -- upper right corner
   cells = {16, 2, 16*2}, -- number of cells
   cflFrac = 0.9,
