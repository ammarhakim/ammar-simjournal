...
initProfile = "cosine" -- one of "gaussian", "step", "cylinder", "expTent", "square-hat", "gaussian"
...
function cosine(t, xn)
   return 1.0 + math.cos(2*2*math.pi*xn[1])
end
...
elseif initProfile == "square-hat" then
   initFunc = squareHat
elseif initProfile == "cosine" then
   initFunc = cosine
else
   initFunc = nil
end
