...
# density
d = postgkyl.GData("x13-2x3v-max-mom_numDensity.bp")
dg1Num = postgkyl.gInterp.GInterpModalMaxOrder(d, 3)
...
# momentum-x
d = postgkyl.GData("x13-2x3v-max-mom_momentum.bp")
dg1Mom = postgkyl.gInterp.GInterpModalMaxOrder(d, 3)
...
# total Pxx
d = postgkyl.GData("x13-2x3v-max-mom_pressureTensor.bp")
dg1Pr = postgkyl.gInterp.GInterpModalMaxOrder(d, 3)
...
# ptcl energy
d = postgkyl.GData("x13-2x3v-max-mom_ptclEnergy.bp")
dg1Eg = postgkyl.gInterp.GInterpModalMaxOrder(d, 3)
