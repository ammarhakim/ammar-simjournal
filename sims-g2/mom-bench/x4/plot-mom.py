...
# density
d = postgkyl.GData("x4-1x2v-max-mom_numDensity.bp")
...
minorticks_on()
grid()
savefig('x4-1x2v-max-num.png', bbox='tight')

# momentum-x
d = postgkyl.GData("x4-1x2v-max-mom_momentum.bp")
...
minorticks_on()
grid()
savefig('x4-1x2v-max-momx.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x4-1x2v-max-momy.png', bbox='tight')

# total Pxx
d = postgkyl.GData("x4-1x2v-max-mom_pressureTensor.bp")
...
minorticks_on()
grid()
savefig('x4-1x2v-max-pxx.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x4-1x2v-max-pyy.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x4-1x2v-max-pxy.png', bbox='tight')

# ptcl energy
d = postgkyl.GData("x4-1x2v-max-mom_ptclEnergy.bp")
...
minorticks_on()
grid()
savefig('x4-1x2v-max-Eg.png', bbox='tight')
