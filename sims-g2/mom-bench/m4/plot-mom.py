...
# density
d = postgkyl.GData("m4-1x2v-ser-mom_numDensity.bp")
dg1Num = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder2Basis(d)
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-num.png', bbox='tight')

# momentum-x
d = postgkyl.GData("m4-1x2v-ser-mom_momentum.bp")
dg1Mom = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder2Basis(d)
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-momx.png', bbox='tight')
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-momy.png', bbox='tight')

# total Pxx
d = postgkyl.GData("m4-1x2v-ser-mom_pressureTensor.bp")
dg1Pr = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder2Basis(d)
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-pxx.png', bbox='tight')
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-pyy.png', bbox='tight')
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-pxy.png', bbox='tight')

# ptcl energy
d = postgkyl.GData("m4-1x2v-ser-mom_ptclEnergy.bp")
dg1Eg = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder2Basis(d)
...
minorticks_on()
grid()
savefig('m4-1x2v-ser-Eg.png', bbox='tight')
