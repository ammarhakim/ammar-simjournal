...
minorticks_on()
grid()
savefig('x5-1x2v-max-num.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x5-1x2v-max-momy.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x5-1x2v-max-pxy.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x5-1x2v-max-Eg.png', bbox='tight')
