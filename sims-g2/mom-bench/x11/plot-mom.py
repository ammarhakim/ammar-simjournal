...
# density
d = postgkyl.GData("x11-2x3v-max-mom_numDensity.bp")
...
# momentum-x
d = postgkyl.GData("x11-2x3v-max-mom_momentum.bp")
...
# total Pxx
d = postgkyl.GData("x11-2x3v-max-mom_pressureTensor.bp")
...
# ptcl energy
d = postgkyl.GData("x11-2x3v-max-mom_ptclEnergy.bp")
