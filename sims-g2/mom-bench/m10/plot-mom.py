...
dg1Num = postgkyl.GInterpModalSerendipity(d, 4)
...
dg1Mom = postgkyl.GInterpModalSerendipity(d, 4)
...
dg1Pr = postgkyl.GInterpModalSerendipity(d, 4)
...
dg1Eg = postgkyl.GInterpModalSerendipity(d, 4)
