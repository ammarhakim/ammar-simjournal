...
# density
d = postgkyl.GData("m10-1x3v-ser-mom_numDensity.bp")
dg1Num = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder4Basis(d)
...
# momentum-x
d = postgkyl.GData("m10-1x3v-ser-mom_momentum.bp")
dg1Mom = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder4Basis(d)
...
# total Pxx
d = postgkyl.GData("m10-1x3v-ser-mom_pressureTensor.bp")
dg1Pr = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder4Basis(d)
...
# ptcl energy
d = postgkyl.GData("m10-1x3v-ser-mom_ptclEnergy.bp")
dg1Eg = postgkyl.gInterp.GkeDgSerendipModal1DPolyOrder4Basis(d)
