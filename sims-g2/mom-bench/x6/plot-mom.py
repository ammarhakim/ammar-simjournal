...
# density
d = postgkyl.GData("x6-1x2v-max-mom_numDensity.bp")
dg1Num = postgkyl.gInterp.GInterpModalMaxOrder(d, 4)
...
minorticks_on()
grid()
savefig('x6-1x2v-max-num.png', bbox='tight')

# momentum-x
d = postgkyl.GData("x6-1x2v-max-mom_momentum.bp")
dg1Mom = postgkyl.gInterp.GInterpModalMaxOrder(d, 4)
...
minorticks_on()
grid()
savefig('x6-1x2v-max-momx.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x6-1x2v-max-momy.png', bbox='tight')

# total Pxx
d = postgkyl.GData("x6-1x2v-max-mom_pressureTensor.bp")
dg1Pr = postgkyl.gInterp.GInterpModalMaxOrder(d, 4)
...
minorticks_on()
grid()
savefig('x6-1x2v-max-pxx.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x6-1x2v-max-pyy.png', bbox='tight')
...
minorticks_on()
grid()
savefig('x6-1x2v-max-pxy.png', bbox='tight')

# ptcl energy
d = postgkyl.GData("x6-1x2v-max-mom_ptclEnergy.bp")
dg1Eg = postgkyl.gInterp.GInterpModalMaxOrder(d, 4)
...
minorticks_on()
grid()
savefig('x6-1x2v-max-Eg.png', bbox='tight')
