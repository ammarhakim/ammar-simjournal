...
dg1Num = postgkyl.GInterpModalMaxOrder(d, 1)
...
dg1Mom = postgkyl.GInterpModalMaxOrder(d, 1)
...
dg1Pr = postgkyl.GInterpModalMaxOrder(d, 1)
...
dg1Eg = postgkyl.GInterpModalMaxOrder(d, 1)
