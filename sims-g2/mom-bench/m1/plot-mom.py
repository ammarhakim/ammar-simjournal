...
minorticks_on()
grid()
savefig('m1-1x1v-ser-num.png', bbox='tight')
...
minorticks_on()
grid()
savefig('m1-1x1v-ser-mom.png', bbox='tight')
...
minorticks_on()
grid()
savefig('m1-1x1v-ser-pr.png', bbox='tight')
...
minorticks_on()
grid()
savefig('m1-1x1v-ser-Eg.png', bbox='tight')
